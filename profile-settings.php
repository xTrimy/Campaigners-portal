...
if (isset($_POST['submit'])) {
  ...
  //Photo Upload END
  DB::query(
    'UPDATE members SET nickname=:nickname,phone=:phone,bio=:bio,birthdate=:birthdate,name=:name,email=:email,university_id=:university_id WHERE id=:id',
    array(
      ':id' => $user_id,
      ':bio' => $bio,
      ':birthdate' => $birthdate,
...
$item = DB::query('SELECT * FROM members WHERE id=:id', array(':id' => $user_id))[0];
?>
<div id="main-body">
    ...
    <div class="row">
      <div class="item">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <p>Name :</p>
          <input type="text" class="binput" name="name" value="<?php echo $item['name']; ?>"><br>
          <p>University ID :</p>
          <input type="text" class="binput" name="university_id" value="<?php echo $item['university_id']; ?>"><br>
          <p>Nickname :</p>
          ...
          <p>Email :</p>
          <input type="text" class="binput" name="email" value="<?php echo $item['email']; ?>"><br>
